...
import com.championash5357.tutorial.slot.SlotDualFurnaceFuel;
import com.championash5357.tutorial.slot.SlotDualFurnaceOutput;
...
public class ContainerDualFurnace extends Container {
	...
	public ContainerDualFurnace(InventoryPlayer player, TileEntityDualFurnace tileentity) {
		...
		this.addSlotToContainer(new SlotDualFurnaceOutput(player.player, tileentity, 3, 80, 19));
